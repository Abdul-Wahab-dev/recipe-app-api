...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_bad_credentials(self):
        ...
        payload = {'email': 'test@example.com', 'password': '54321' }
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(email='test@example.com',password='12345678',name='Abdul Wahab')
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'test@example.com' , 'password':'12345678'}
